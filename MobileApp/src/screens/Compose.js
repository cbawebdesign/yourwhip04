...
import {Platform, View, ScrollView, Keyboard, TouchableOpacity, Text} from 'react-native';
    ...
    if (Platform.OS === 'web') {
        return (
          <View style={{backgroundColor: 'red', width: '100%', height: '100%', alignItems: 'center', justifyContent: 'center'}}>
            <TextInput value={caption} onChangeText={t => setCaption(t)} placeholder="Caption" />
            <input
              type="file"
              name="file-upload"
